...
import { Bot, Settings, Users, BarChart3, MapPinned, Activity } from "lucide-react"; // Added MapPinned and Activity
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <Link href="/admin/ai-supervision" className="block hover:no-underline">
          <Card className="hover:border-primary transition-colors duration-200 shadow-md hover:shadow-lg h-full">
      ...
      <Card className="mt-8 shadow-md">
        ...
        <CardContent>
          <div className="h-64 flex items-center justify-center text-muted-foreground border-2 border-dashed border-border rounded-lg">
            ...
            <BarChart3 className="h-12 w-12 text-muted-foreground/50 ml-4" />
          </div>
        </CardContent>
      </Card>
    </div>
