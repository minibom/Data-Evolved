...
import {ai} from '../../../game-ai-genkit/genkit'; // Adjusted path to local genkit instance
import {
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are the AI Core, responsible for maintaining stability and engagement in the game world "Data Evolved".
